...
# ==================== MAIN ====================
def run_monitor():
    print("🚀 Iniciando ZeroTier Monitor - Versión Mínima")
    ...
    try:
        ...
        if contents:
            repo.update_file(path=HISTORIAL_FILE, message=f"Auto-Monitor {ahora.strftime('%H:%M')}", content=new_content, sha=contents.sha)
        else:
